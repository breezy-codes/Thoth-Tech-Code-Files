...
namespace Program
{
    public class Program
    {
        public static void Main()
        {
            ...
            SplashKit.WriteLine("Convert IP addresses from IPv4 to hexadecimal format.");
            ...
            while (!exitRequested)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        string ipAsHex = SplashKit.Ipv4ToHex(ipInput);

                        // Display the results
                        SplashKit.WriteLine("The IP address in hexadecimal format is: " + ipAsHex);
                    }
                }
            }
        }
