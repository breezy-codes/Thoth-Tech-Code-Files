...
WriteLine("Convert IP addresses from IPv4 to hexadecimal format.");
...
while (!exitRequested)
{
    ...
    else
    {
        ...
        else
        {
            ...
            string ipAsHex = Ipv4ToHex(ipInput);

            // Display the results
            WriteLine("The IP address in hexadecimal format is: " + ipAsHex);
        }
    }
}
